...
const UpdateJob = () => {
  ...
  const onSubmit = (data) => {
    ...
    // console.log(data)
    fetch(`http://localhost:3000/update-jb/${id}`, {
      method: "PATCH", 
         ...
         <div className='create-job-flex'>
           ...
           <div className='create-job-flex'>
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="date" defaultValue={postingDate} placeholder='Ex: 2024-02-24' {...register("postingDate")}  className="create-job-input"/>
              </div>
              <div className='lg:w-1/2 w-full'>
            ...
            <label className='block mb-2 text-lg '>Required Skill Sets:</label>
              <CreatableSelect defaultValue={skills} onChange={setSelectedOption} options={options} isMulti className='create-job-input py-4'></CreatableSelect>
            </div>
            ...
            <div className='create-job-flex'>
              <div className='lg:w-1/2 w-full'>
                ...
                <input type="url" defaultValue={companyLogo} placeholder='Paste your company logo URL: https://weshare.img1/' {...register("companyLogo")}  className="create-job-input"/>
              </div>
              <div className='lg:w-1/2 w-full'>
